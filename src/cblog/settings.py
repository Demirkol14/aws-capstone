...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/django/rdsusername", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/django/rdspassword", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'django-rds.cngumm8wqdh3.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'django-s3-bucket18' # please enter your s3 bucket name
