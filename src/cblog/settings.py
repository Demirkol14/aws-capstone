...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/deco/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/deco/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cngumm8wqdh3.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-deco-blog' # please enter your s3 bucket name
